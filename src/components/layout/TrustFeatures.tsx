      ...
      <section
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-white/5 border-2 border-white/10 p-6 rounded-3xl backdrop-blur-md hover:-translate-y-1 hover:border-emerald-500/30  hover:shadow-[0_0_30px_rgba(16,185,129,0.05)] transition-all duration-300 flex flex-col gap-4 group">
            ...
            <div>
              <h3 className="text-white font-bold text-[19px] tracking-wide mb-1 border-b-[3px] border-white/30 ">
                100% Verified Places
              </h3>
          ...
          <div className="bg-white/5 border-white/10 border-2 p-6 rounded-3xl backdrop-blur-md hover:-translate-y-1 hover:border-emerald-500/30 hover:shadow-[0_0_30px_rgba(16,185,129,0.05)] transition-all duration-300 flex flex-col gap-4 group">
            <div className="w-12 h-12 bg-emerald-500/10 rounded-2xl flex items-center justify-center text-emerald-400 group-hover:bg-emerald-500 group-hover:text-white transition-all duration-300">
              <FaUsers size={18} />
            </div>
            <div>
