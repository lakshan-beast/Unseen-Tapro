...
//       }
//       // NOTE: assumes id is a numeric string (e.g. "12"). If your ids are
//       // UUIDs/slugs, sort by an actual createdAt/date field instead.
...
//               Heavy rainfalls are currently active. Flash floods around waterfalls and
//               thick mist on mountain ridges (Knuckles/Ella) are expected. Cross-reference
//               regional helplines before leaving.
//             </p>
//           </div>
//         </div> */}
//       </div>
...
//                       )}
//                       <span>
//                         {savedPlaces.has(place.id) ? "Saved" : "Save"}
//                       </span>
//                     </button>
...
import { sriLankaDistricts } from "../data/sriLankaDistricts";
import { db } from "../lib/firebase"; // ඔබේ firebase.ts path එක අනුව අවශ්‍ය නම් වෙනස් කරන්න
...
// Firestore Document සඳහා Interface එක
interface PlaceItem {
  id: string;
  title: string;
  district: string;
