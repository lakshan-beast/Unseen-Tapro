...
//             <a
//               href="tel:1990"
//               className="flex-1  sm:flex-none text-center bg-red-500 hover:bg-red-600 text-white font-black px-6 py-3 rounded-xl text-xs tracking-wider uppercase transition-all shadow-lg shadow-red-500/10 ">
//               <MdOutlineWifiCalling3  className="size-5"/> 1990 Ambulance
//             </a>
//             <a
//               href="tel:1912"
...
//               <GiSiren className="size-5 text-emerald-500" /> Tourist Police
//             </a>
//           </div>
//         </div>
//       </section>
